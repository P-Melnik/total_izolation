...
public class AddTwoNumbersNum2 {
    ...
    public ListNode addTwoNumbersRecursive(ListNode l1, ListNode l2) {
        return callRecursiveAddTwoNimbers(l1, l2, 0);
    }

    private ListNode callRecursiveAddTwoNimbers(ListNode l1, ListNode l2, int carry) {
        ...
        node.next = callRecursiveAddTwoNimbers(l1, l2, sum / 10);
